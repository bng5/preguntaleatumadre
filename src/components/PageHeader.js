    ...
    return (
      <section className="page-header">
        <div className="header-title__top">
          ...
          <div className={'podcast-subscription' + (this.state.showPodcast ? '' : ' hidden')}>
        ...
        <p className={'page-header__cuando' + (this.state.showPodcast ? ' hidden' : '')}>Miércoles 22 hs. por <a href="http://www.mediarte.com.uy/" rel="noopener noreferrer" target="_blank">Mediarte</a></p>
